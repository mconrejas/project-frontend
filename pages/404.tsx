      ...
      Page Not Found
        ...
        <button className="mt-5">
            ...
            >
              ...
              {/* <span className="relative block px-8 py-3 bg-[#1A2238] border border-current"></span> */}
              <span className="relative block px-8 py-3 bg-[#1A2238] border border-current hover:bg-white">
              <Link href="/" className='hover:text-red-500'> back to home page</Link></span>
            </div>
        </button>
</main>
  );
